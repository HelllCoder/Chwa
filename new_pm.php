...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
    	<div class="header">
        	<a href="<?php echo $url_home; ?>"><img src="<?php echo $design; ?>" alt="Members Area" /></a>
	    </div>
<?php
...
if(isset($_POST['title'], $_POST['recip'], $_POST['message']))
{
	...
	if($_POST['title']!='' and $_POST['recip']!='' and $_POST['message']!='')
	{
		...
		$dn1 = mysql_fetch_array(mysql_query('select count(id) as recip, id as recipid, (select count(*) from pm) as npm from uzivatele where jmeno="'.$recip.'"'));
		if($dn1['recip']==1)
		{
